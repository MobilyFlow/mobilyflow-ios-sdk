...
@objc class MobilyPurchaseSDKImpl: NSObject {
    ...
    @objc public init(
        ...
        super.init()
        self.reinit(appId: appId, apiKey: apiKey, environment: environment, options: options)
    ...
    @objc public func getSubscriptionGroupById(id: UUID) async throws -> MobilySubscriptionGroup {
        try await syncer!.ensureSync()
    ...
    @objc public func getEntitlementForSubscription(subscriptionGroupId: UUID) async throws -> MobilyCustomerEntitlement? {
