...
@property (nonatomic, readonly, copy) NSUUID * _Nonnull customerId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSDate * _Nonnull createdAt;
@property (nonatomic, readonly, copy) NSDate * _Nonnull updatedAt;
@property (nonatomic, readonly, copy) NSUUID * _Nullable transactionId;
@property (nonatomic, readonly, copy) NSUUID * _Nullable subscriptionId;
@property (nonatomic, readonly, copy) NSUUID * _Nullable itemId;
@property (nonatomic, readonly, copy) NSString * _Nonnull type;
...
@property (nonatomic, readonly, copy) NSDate * _Nonnull createdAt;
@property (nonatomic, readonly, copy) NSDate * _Nonnull updatedAt;
@property (nonatomic, readonly, copy) NSUUID * _Nonnull productId;
...
SWIFT_CLASS("_TtC13MobilyflowSDK29MobilyProductOfferPricingMode")
@interface MobilyProductOfferPricingMode : NSObject
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull INTRODUCTORY;)
+ (NSString * _Nonnull)INTRODUCTORY SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull DEVELOPER_DETERMINED;)
+ (NSString * _Nonnull)DEVELOPER_DETERMINED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<NSString *> * _Nonnull values;)
+ (NSArray<NSString *> * _Nonnull)values SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
+ (void)getSubscriptionGroupById:(NSUUID * _Nonnull)id completionHandler:(void (^ _Nonnull)(MobilySubscriptionGroup * _Nullable, NSError * _Nullable))completionHandler;
+ (void)DANGEROUS_getProductFromCacheWithId:(NSUUID * _Nonnull)id completionHandler:(void (^ _Nonnull)(MobilyProduct * _Nullable))completionHandler;
...
+ (void)sendDiagnosticWithCompletionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
...
@property (nonatomic, readonly, copy) NSDate * _Nonnull updatedAt;
@property (nonatomic, readonly, copy) NSUUID * _Nonnull productId;
@property (nonatomic, readonly, copy) NSUUID * _Nullable productOfferId;
@property (nonatomic, readonly, copy) NSDate * _Nonnull startDate;
@property (nonatomic, readonly, copy) NSDate * _Nonnull endDate;
@property (nonatomic, readonly, copy) NSString * _Nonnull platform;
@property (nonatomic, readonly, copy) NSUUID * _Nullable renewProductId;
@property (nonatomic, readonly, copy) NSUUID * _Nullable renewProductOfferId;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull priceFormatted;
@property (nonatomic, readonly, copy) NSString * _Nonnull type;
@property (nonatomic, readonly, copy) NSString * _Nonnull pricingMode;
@property (nonatomic, readonly) NSInteger periodCount;
@property (nonatomic, readonly, copy) NSString * _Nonnull periodUnit;
